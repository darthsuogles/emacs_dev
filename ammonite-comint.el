...
(defcustom sbt:console-history-file "~/.ammonite/.history"
...
(defcustom sbt:console-prompt-regexp "^amm>[ ]*"
...
(defcustom sbt:prompt-regexp "^\\(\\(amm\\|\\[[^\]]*\\] \\)?[>$]\\|[ ]+|\\)[ ]*"
